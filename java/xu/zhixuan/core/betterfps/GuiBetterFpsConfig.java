...
public class GuiBetterFpsConfig extends GuiScreen {
    ...
    private List<GuiButton> initButtons() {
        ...
        buttons.add(new GuiCycleButton.GuiBooleanButton(3, "Update Checker", config.updateChecker, new String[] {
                        "Whether will check for updates on startup",
                        "It's highly recommended enabling this option", "",
                        "Default: On"
        }));
        buttons.add(new GuiCycleButton.GuiBooleanButton(4, "Preallocate Memory", config.preallocateMemory, new String[] {
        ...
        buttons.add(new GuiCycleButton.GuiBooleanButton(5, "Fast Box Render", config.fastBoxRender, new String[] {
                        "Whether will only render the exterior of boxes.",
                        "§cRequires restarting to take effect", "",
                        "Default in Vanilla: Off",
                        "Default in BetterFps: On"
        }));
        buttons.add(new GuiCycleButton.GuiBooleanButton(6, "Fog", config.fog, new String[] {
                        "Whether will render the fog.",
                        "§cRequires restarting to take effect", "",
                        "Default: On"
        }));
        buttons.add(new GuiCycleButton.GuiBooleanButton(7, "Fast Hopper", config.fastHopper, new String[] {
                        "Whether will improve the hopper.",
                        "§cRequires restarting to take effect", "",
                        "Default in Vanilla: Off",
                        "Default in BetterFps: On"
        }));
        buttons.add(new GuiCycleButton.GuiBooleanButton(8, "Fast Beacon", config.fastBeacon, new String[] {
