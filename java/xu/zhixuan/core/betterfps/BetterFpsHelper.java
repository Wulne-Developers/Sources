...
public class BetterFpsHelper {
    ...
    public static BetterFpsConfig loadConfig() {
        ...
        if(MCDIR == null) {
            CONFIG_FILE = new File("WulneClient/Settings/config" + File.pathSeparator + "betterfps.json");
        } else {
            CONFIG_FILE = new File(MCDIR, "WulneClient/Settings/config" + File.pathSeparator + "betterfps.json");
        }
