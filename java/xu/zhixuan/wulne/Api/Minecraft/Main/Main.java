package xu.zhixuan.wulne.Api.Minecraft.Main;
...
public class Main
{
    public static void main(String[] p_main_0_) throws IOException {
        ...
        OptionSpec<String> optionspec9 = optionparser.accepts("username").withRequiredArg().defaultsTo("Frish2021");// + Minecraft.getSystemTime() % 1000L, new String[0]
