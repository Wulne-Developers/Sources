package xu.zhixuan.wulne.UI.loading;
...
public class SplashProgress {
	...
	public static void drawSplash(TextureManager tm) {
		...
		if (splash == null) {
			splash = new ResourceLocation("Wulne/load/Splash.png");
		}
	...
	public static void drawProgress() {
		...
		Gui.drawRect(0, sr.getScaledHeight() - 2, (int)calc, sr.getScaledWidth(), new Color(77, 239, 80).getRGB());
