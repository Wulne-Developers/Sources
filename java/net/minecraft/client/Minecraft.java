...
import xu.zhixuan.core.modules.BlockAni;
...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    private void startGame() throws LWJGLException, IOException {
        WulneJvav.INSTANCE.onInit();
        Wulne.INSTANCE.onInit();
        ...
        WulneJvav.INSTANCE.onStart();
        Wulne.INSTANCE.onStart();
        WulneJvav.INSTANCE.start();
    }
    ...
    public void shutdownMinecraftApplet() throws IOException {
        WulneJvav.INSTANCE.onStop();
        Wulne.INSTANCE.onStop();
        try {
    ...
    private void sendClickBlockToController(boolean leftClick) {
        if (WulneJvav.INSTANCE.moduleManager.getModByClass(BlockAni.class).isEnabled()) {
            if (BlockAni.mod.getValue() == BlockAni.Block.Null) {
                if (!leftClick) {
    ...
    public void runTick() throws IOException {
        EventManager.call(new EventTick(EventCategory.PRE));
        ...
        EventManager.call(new EventTick(EventCategory.POST));
    }
