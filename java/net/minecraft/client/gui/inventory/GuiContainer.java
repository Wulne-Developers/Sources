...
import xu.zhixuan.core.modules.Gloabl.ContainerAnimations;
import xu.zhixuan.core.modules.Gloabl.util.Translate;
...
public abstract class GuiContainer extends GuiScreen
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        if (WulneJvav.INSTANCE.moduleManager.getModByClass(ContainerAnimations.class).isEnabled()) {
            if ((boolean) ContainerAnimations.logout.getValue()) {
                FontLoaders.msFont22.drawString("WulneClient" + " by Frish2021", 2, this.height - 10, -1);
            }
        }
        ...
        if (WulneJvav.INSTANCE.moduleManager.getModByClass(ContainerAnimations.class).isEnabled()) {
            if ((boolean) ContainerAnimations.ronqidonghua.getValue()) {
        ...
        if (WulneJvav.INSTANCE.moduleManager.getModByClass(ContainerAnimations.class).isEnabled()) {
            if ((boolean) ContainerAnimations.ronqidonghua.getValue()) {
                GlStateManager.scale(this.width / translate.getX(), this.height / translate.getY(), 1);
                GlStateManager.translate(-xmod, -ymod, 0);
            }
        }
    }
