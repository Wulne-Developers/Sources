...
import xu.zhixuan.core.events.Client.EventChat;
import xu.zhixuan.core.modules.Chat;
...
public class GuiNewChat extends Gui
{
                    ...
                    if (chatline != null)
                    {
                        ...
                        if (j1 < 200 || flag)
                        {
                            ...
                            if (l1 > 3)
                            {
                                int i2 = 0;
                                int j2 = -i1 * 9;
                                if (WulneJvav.INSTANCE.moduleManager.getModByClass(Chat.class).isEnabled()) {
                                ...
                                if (WulneJvav.INSTANCE.moduleManager.getModByClass(Chat.class).isEnabled()) {
                                    float width = FontLoaders.msFont18.getStringWidth(s);
                                    if (l1 == 255) {
                                        chatline.x = chatline.animationUtils.animate(width,chatline.x,0.02f);
                                    } else {
                                        chatline.x = chatline.animationUtils.animate(0,chatline.x,0.02f);
                                    }
                                    FontLoaders.msFont18.drawStringWithShadow(s, chatline.x - width, (float)(j2 - 8), 16777215 + (l1 << 24));
                                } else {
                                    FontLoaders.msFont18.drawStringWithShadow(s, (float) i2, (float)(j2 - 8), 16777215 + (l1 << 24));
                                }
    ...
    {
        EventChat eventChat = new EventChat(chatComponent.getFormattedText());
