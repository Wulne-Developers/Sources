...
import xu.zhixuan.core.modules.CustomScoreboard;
...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float partialTicks)
    {
        ...
        if (!WulneJvav.INSTANCE.moduleManager.getModByClass(CustomScoreboard.class).isEnabled()) {

            if (scoreobjective1 != null)
            {
                this.renderScoreboard1(scoreobjective1, scaledresolution);
            }
        }
        ...
        EventManager.call(new EventRender2D(partialTicks,scaledresolution));
    ...
    public void renderScoreboard(ScoreObjective objective, ScaledResolution scaledRes)
    {
        ...
        for (Score score1 : collection)
        {
            ...
            if (WulneJvav.INSTANCE.moduleManager.getModByClass(CustomScoreboard.class).isEnabled()) {
                if ((boolean) CustomScoreboard.bor.getValue()) {
            ...
            if (WulneJvav.INSTANCE.moduleManager.getModByClass(CustomScoreboard.class).isEnabled()) {
                if ((boolean) CustomScoreboard.rednumbers.getValue()) {
    ...
    public void renderScoreboard1(ScoreObjective objective, ScaledResolution scaledRes)
    {
        Scoreboard scoreboard = objective.getScoreboard();
        Collection<Score> collection = scoreboard.getSortedScores(objective);
        List<Score> list = Lists.newArrayList(Iterables.filter(collection, new Predicate<Score>()
