...
import xu.zhixuan.core.betterfps.GuiBetterFpsConfig;
...
public class GuiOptions extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(114, this.width / 2 + 5, this.height / 6 + 48 - 6, 150, 20, "BetterFPS Setting"));
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        if (button.enabled)
        {
            ...
            if (button.id == 114) {
                this.mc.displayGuiScreen(new GuiBetterFpsConfig());
            }
