...
import xu.zhixuan.core.events.Player.EventUpdate;
import xu.zhixuan.core.modules.noCommand;
...
import xu.zhixuan.wulne.Util.Client.ErrorUtil;
...
public class EntityPlayerSP extends AbstractClientPlayer {
    ...
    public void sendChatMessage(String message) {
        if (!WulneJvav.INSTANCE.moduleManager.getModByClass(noCommand.class).isEnabled()) {
            try {
