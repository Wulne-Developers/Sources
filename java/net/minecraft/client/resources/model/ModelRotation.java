...
public enum ModelRotation implements IModelState, ITransformation
{
    ...
    public xu.zhixuan.wulne.Api.vecmath.Matrix4f getMatrix()
    {
        return Reflector.ForgeHooksClient_getMatrix.exists() ? (xu.zhixuan.wulne.Api.vecmath.Matrix4f)Reflector.call(Reflector.ForgeHooksClient_getMatrix, new Object[] {this}): new xu.zhixuan.wulne.Api.vecmath.Matrix4f(this.getMatrix4d());
    }
