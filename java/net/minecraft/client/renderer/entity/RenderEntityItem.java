...
import xu.zhixuan.core.modules.ItemPichyec;
import xu.zhixuan.core.modules.util.ItemPhysicRender;
...
public class RenderEntityItem extends Render<EntityItem>
{
    ...
    {
        if(WulneJvav.INSTANCE.getModuleManager().getModByClass(ItemPichyec.class).isEnabled())
        {
